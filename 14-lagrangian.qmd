...
So either $y=0$ or $\lambda = 0$. We reject $y=0$ since subistuting $x=0$ and $y=0$ into $(3)$, $x^2 +2y^2 = 6$, we get $0^2 + 0^2 = 6$ which is nonsense. So taking the case where $\lambda = 0$ and $y$ is non zero we have.
...
Phew! So the final answer is $(0,\sqrt{3})$, $(2,1)$ and $(-2,1)$ are the local maximum values of $x^2y$ subject to $x^2 +2y^2 = 6$. To find the absolute maximum values we would have to substitute them into the orginial function.
