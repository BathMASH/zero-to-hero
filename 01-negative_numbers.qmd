...
* $1 - - 3 = 4$, start at $1$ then reverse a shift of $3$ to the left. The moving left backwards cancels out to give our answer of $4$.

**Warning:** It's tempting to cling on to the idea that *two negatives make a positive* when it comes to addition and subtraction. But consider the following statements, they are all correct, but imagine how easy it is to be confused if you just apply the *two negatives make a positive* rule.
