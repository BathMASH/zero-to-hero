...
```{r, echo=FALSE, eval=(knitr::pandoc_to("html"))}
knitr::include_url("https://numbas.mathcentre.ac.uk/question/125598/negative-numbers-multiplication-and-division/embed/", height="400px")
```
...
The result of the multiplication decreases by two each time - the pattern continues into the negative numbers.
...
Notice how as we multiply $-2$ by a smaller number the result increases. Continuing the pattern to multiply $-2$ by a negative number naturally gives us a positive result.

Our definition fits the pattern. Hurrah!
...
If a firm's revenue is £500,000 and its costs are £550,000, its profit is $500000 - 550000 = -50000$. The negative sign shows the firm is making a loss of £50,000.
::::
...
```{r, echo=FALSE, eval=(knitr::pandoc_to("html"))}
knitr::include_url("https://numbas.mathcentre.ac.uk/question/126315/negative-numbers-addition-and-subtraction/embed/?token=1a99ce84-edc0-4467-a780-e6e9bcc6fda8", height="400px")
```
