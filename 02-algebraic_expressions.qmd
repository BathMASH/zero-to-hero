...
knitr::include_url("https://uniofbath.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=a67330c2-9c55-4dde-9366-af0f010a32ac&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all", height="405px")
```
...
```{r, echo=FALSE, eval=(knitr::pandoc_to("html"))}
knitr::include_url("https://uniofbath.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=c2aeab22-f27e-4ba2-baea-af0f010a32ad&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all", height="405px")
```
...
$$
Notice that the like terms were grouped first to make it easier to simplify. Also, each term *owns* the positive of negative symbol ahead of it.
