...
Greek letters appear frequently in economics. $\pi$ (pi) is used for profit, $\Delta$ (delta) for change, and $\varepsilon$ (epsilon) for elasticity. A demand elasticity of $\varepsilon = -1.5$ means that a $1\%$ increase in price leads to a $1.5\%$ decrease in quantity demanded.
::::
