...
This factorises to $(Q-6)(Q-2)=0$. When two brackets multiply to give zero, at least one of them must be zero. So either $Q-6=0$ or $Q-2=0$. The firm breaks even when output is $Q=2$ and $Q=6$. Between these two points the firm makes a net profit; outside them it makes a loss.
