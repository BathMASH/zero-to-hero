...
Economists call this responsiveness **elasticity**. A steep demand curve means buyers are not very responsive to price changes: demand is *inelastic*. A flatter curve means buyers are very responsive: demand is *elastic*.

```{r, echo=FALSE, fig.height=3.5, fig.width=5, fig.align='center', fig.alt='A downward-sloping straight line showing a demand curve with intercept 20 on the price axis and slope negative 2.'}
