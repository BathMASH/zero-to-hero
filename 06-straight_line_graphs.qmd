...
warning = ""
open_desmos_warning = ""
close_desmos_warning = ""
```
```{r, echo=FALSE, eval=(knitr::pandoc_to("html"))}
warning =  ":::{.callout-tip}
## Using Desmos
![]('img/desmos.gif')The graphs and diagrams created in [desmos](https://www.desmos.com/calculator) are interactive just click on the 'edit in desmos' button to open the desmos graph in a new tab.
:::"
open_desmos_warning = ":::{.callout-tip}
## Using Desmos"
close_desmos_warning = "The graphs and diagrams created in [desmos](https://www.desmos.com/calculator) are interactive just click on the 'edit in desmos' button to open the desmos graph in a new tab.
:::"
```
